...
<body>
    <div class="container">
        ...
        <div class="content" style="text-align: center">
            ...
            <ul>
                <li><strong>Nom et Prénoms :</strong> {{ $teacher->name }}</li>
                <li><strong>Adresse e-mail :</strong> {{ $teacher->email }}</li>
                <li><strong>Téléphone :</strong> {{ $teacher->phone }}</li>
                <li><strong>Mot de passe temporaire :</strong> LesTutorielsTuteurs</li>
            </ul>
